...
public class FamMem {
    ...
    //private integer variable to hold the resource id
    ...
    public FamMem (String defaultTranslation, String miwokTranslation, int audioResourceID){
    ...
    public FamMem (String defaultTranslation, String miwokTranslation, int imageResourceID, int audioResourceID){
        mDefaultTranslation = defaultTranslation;
        mMiwokTranslation = miwokTranslation;
